...
/**
 * @param {api.RequestData} data
 * @param {(errors: ValidationError[], putData?: PatchData) => void} callback
 */
const patch = function patch(data, callback) {
  ...
  // Recreate validator so that it only contains user data.
...
const userValidator = function userValidator() {
  return { post, get, patch, delete: del }
}
