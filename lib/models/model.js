...
class Model {
  ...
  async delete(id) {
    ...
    await deleteFile(this._name, this.id)
  }
   ...
   * @returns {Record}
   */
  serialize() { throw new NotImplementedError('serialize is not implemented') }
   ...
   * @param {Record} record
   */
  deserialize(record) { throw new NotImplementedError('deserialize is not implemented') }
