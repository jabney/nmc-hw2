...
class MailgunService {
  ...
  constructor(msginfo) {
    ...
    this.msginfo.from = `Big Bear <bigbear@${config.mailgun.domain}>`
  }
  ...
  async send() {
    ...
    const response = await makeRequest(options, multipart.body)
...
// const ms = new MailgunService({
//   to: 'james.abney@gmail.com',
//   subject: 'A message from Big Bear',
//   text: 'You have successfully messaged',
// })
