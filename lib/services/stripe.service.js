...
class StripeService {
  ...
  async charge(amount, userEmail) {
    ...
    // An incorrect card number will result in a token error.
    if (typeof tokenResult.id === 'undefined') {
      /**
       * @type {CardFailure}
       */
    ...
    if (typeof chargeResult.id === 'undefined') {
      /**
       * @type {CardFailure}
       */
...
//   // number: testNumbers.incorrect_number,
//   // number: testNumbers.expired_card,
//   number: testNumbers.incorrect_cvc,
//   exp_month: 12,
//   exp_year: 2019,
//   cvc: 123
// })
